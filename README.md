...
## Kata de "arnold-enum-types" en Java

Orientado del: https://github.com/dfleta/richttps://github.com/dfleta/arnold-enum-type.git
### Descripción:

Es un kata orienbtado al enum en Java.
